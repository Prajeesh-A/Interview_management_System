        ...
        <div class="opt-container">
            ...
            <div class="row">
                <div class="option" id="mcdonalds">
                    <a href="score.php"><img src="https://cdn.vectorstock.com/i/preview-1x/48/15/computer-network-logo-design-monitor-display-vector-34214815.webp" width=150 height=150></a>
                    <div class="dept">CT</div>
                </div>
                <div class="option" id="chipotle">
                    <a href="score.php"><img src="https://cdn.vectorstock.com/i/preview-1x/02/40/railway-worker-pixel-perfect-gradient-linear-icon-vector-46910240.webp" width=100 height=100></a>
                    <div class="dept">CE</div>
                </div>
                <div class="option" id="panera">
                    <a href="score.php"><img src="https://cdn.vectorstock.com/i/preview-1x/08/96/icon-mechanical-gears-vector-20000896.webp" width=150 height=150></a>
                    <div class="dept">ME</div>
                </div>
            </div>
            <div class="row">
                <div class="option" id="wendys">
                    <a href="score.php"><img src="https://cdn.vectorstock.com/i/preview-1x/63/88/hand-technology-logo-template-icon-symbol-vector-40356388.webp" width=150 height=150></a>
                    <div class="dept">EL</div>
                </div>
                <div class="option" id="bww">
                    <a href="score.php"><img src="https://cdn.vectorstock.com/i/preview-1x/66/05/electrical-tool-symbol-logo-design-template-vector-33656605.webp" width=100 height=100></a>
