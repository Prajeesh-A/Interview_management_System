    ...
    <div id="signupbox" style=" margin-top:10px" class="mainbox col-md-10 col-md-offset-1 col-sm-8 col-sm-offset-2">
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body" >
                ...
                <div id="div_id_skil" class="form-group required">
                             <label for="id_skil" class="control-label col-md-4  requiredField"> Skils<span class="asteriskField"></span> </label>
                             <div class="controls col-md-8 ">
                                 <input class="input-md textinput textInput form-control" id="skil" name="skil" placeholder="provide skils" style="margin-bottom: 10px" type="text" />
                            </div>
                        </div>
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body" >
                ...
                <div id="div_id_exp" class="form-group required">
                             ...
                             <div class="controls col-md-8 ">
                                 <input class="input-md textinput textInput form-control" id="exp" name="exp" placeholder="provide experience details" style="margin-bottom: 10px" type="text" />
                            </div>
                        </div>
...
<br>
<center>
    <a href="options.php" style="width: 80px;" class="btn btn-primary">Back</a>
</center> 
</br>
